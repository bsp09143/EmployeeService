...
public class EmployeeController {
  ...
  public ResponseEntity<Employee> getEmployeeById(@PathVariable String employeeId) throws EmployeeException
  {
  ...
  public ResponseEntity<Response> deleteEmployeeById(@PathVariable String employeeId)throws EmployeeException {
